...
class capaiantahsin extends Model
{
    protected $table = 'capaian_tahsin';
    ...
    public function pemetaantahsin()
    {
        return $this->hasMany(pemetaantahsin::class, 'id_pemetaan_tahsin');
    }
