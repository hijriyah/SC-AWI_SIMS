...
class DataBimbinganKonselingController extends Controller
{
    ...
    public function index2(Request $request)
    {
        ...
        if($request->ajax())
        {
            $html = view('Pages.admin.guru.bk.databimbingankonseling.partials.table', compact('dataDataBimbinganKonseling'))->render();
            return response()->json([
                'html' => $html
            ]);
        ...
        return view('Pages.admin.guru.bk.databimbingankonseling.databimbingankonseling', compact(['adminSession', 'specAdmin', 'listMenu', 'dataDataBimbinganKonseling', 'SectionType']));
    }
    public function storePage2()
    {
        ...
        return view('Pages.admin.guru.bk.databimbingankonseling.add', compact(['adminSession', 'specAdmin', 'listMenu', 'SectionType', 'dataKelas', 'dataSiswa', 'dataBimbinganKonseling', 'dataTahunAjaran']));
    }
    ...
    public function store2(Request $request)
    {
        ...
        return redirect()->route('guru_bk-databimbingankonseling_page')->with('success', 'data berhasil disimpan');
    }
    public function edit2($uuid)
    {
        ...
        return view('Pages.admin.guru.bk.databimbingankonseling.edit', compact(['adminSession', 'specAdmin', 'listMenu', 'SectionType', 'dataEdit', 'dataKelas', 'dataSiswa', 'dataBimbinganKonseling', 'dataTahunAjaran']));
    }
    public function update2(Request $request, $uuid)
    {
        ...
        return redirect()->route('guru_bk-databimbingankonseling_page')->with('success', 'data berhasil diupdate');
    }
    public function destroy2($uuid)
    {
        ...
        {
            $data->delete();
            return redirect()->route('guru_bk-databimbingankonseling_page')->with('success', 'data berhasil dihapus');
        }
        else {
            return response()->json([
                'error' =>  'data tidak ditemukan'
