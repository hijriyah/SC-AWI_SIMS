...
return new class extends Migration
{
    ...
    {
        Schema::create('capaian_tahsin', function (Blueprint $table) {
            $table->id();
            $table->uuid()->unique();
            $table->foreignId('id_pemetaan_tahsin')->constrained('pemetaan_tahsin')->onDelete('cascade');
            ...
            $table->enum('materi', ['tartil', 'fashohah', 'kelancaran']);
    ...
    {
        Schema::dropIfExists('capaian_tahsin');
    }
};
