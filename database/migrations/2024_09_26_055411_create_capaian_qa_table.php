...
return new class extends Migration
{
    ...
    {
        Schema::create('capaian_qa', function (Blueprint $table) {
            $table->id();
            $table->uuid()->unique();
            ...
            $table->foreignId('id_materi_qa')->constrained('materi_qa')->onDelete('cascade'); //mengambil nama materi dan deskripsi
            $table->longtext('kompetensi'); // diambil dari tabel materi qa
            ...
            $table->enum('status', ['tuntas', 'tuntas_dengan_remidi', 'belum_tuntas']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('capaian_qa');
    }
};
