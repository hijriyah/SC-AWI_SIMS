...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('jurnal_jurnalkesiswaan_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/jurnal/jurnalkesiswaan/delete/" + uuid,
                        type: 'POST',
                        data: {
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 250px;"><b>Daftar Data Jurnal Kesiswaan</b></h4>
                            </div>
                            ...
                            <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('jurnal_jurnalkesiswaan_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{ $item->evaluasi }}</td>
                                        <td style="width: 100px">
                                            <a class="btn btn-outline-danger btn-sm" title="Export To Pdf" href="{{ route('jurnal_jurnalkesiswaan_download', ['id' => $item->id]) }}">
