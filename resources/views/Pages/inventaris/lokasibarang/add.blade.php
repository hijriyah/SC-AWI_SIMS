           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Lokasi Barang</b></h4>
                        <div></div>
               ...
               <form action="{{ route('inventaris_lokasibarang_store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="lokasi_barang" /><br>
                                <!-- input-group -->
