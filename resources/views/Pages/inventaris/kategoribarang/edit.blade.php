           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Edit Kategori Barang</b></h4>
                        <div></div>
               ...
               <form action="{{ route('inventaris_kategoribarang_update', ['uuid' => $dataEdit->uuid]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="kategori" value="{{ $dataEdit->kategori_barang }}" /><br>
                                <!-- input-group -->

                                <label class="form-label">Deskripsi</label>
                                <input class="form-control" name="kategori" value="{{ $dataEdit->deskripsi }}" /><br>
