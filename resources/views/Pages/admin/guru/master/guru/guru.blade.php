...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('guru_gurumaster_page') }}",
            type: "GET",
            data: { search: search},
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 150px;"><b>Daftar Guru</b></h4>
                            </div>
                                ...
                                @foreach ($dataGuru as $item)
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            <a class="btn btn-outline-info btn-sm info" title="Info" href=" {{ route('guru_gurumaster_info', ['uuid' => $item->uuid]) }} ">
