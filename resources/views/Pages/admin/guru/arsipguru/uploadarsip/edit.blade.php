...
$(document).ready(function () {
    ...
    FilePond.setOptions({
        ...
        server: {
            process: {
                url: "{{ route('guru_arsipguru_uploadarsip_update', ['uuid' => $dataEdit->uuid]) }}",
                method: 'POST',
                headers: {
            ...
            $('#tugasForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{ route('guru_arsipguru_uploadarsip_page') }}";
                        }, 2000);
                    },
   ...
   <div class="col-lg-12">
       <div class="card">
           <div class="card-body">
               ...
               <form action="{{ route('guru_arsipguru_uploadarsip_update', ['uuid' => $dataEdit->uuid]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('guru_arsipguru_uploadarsip_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
