...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('guru_akademik-tugassiswa_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/akademik/tugassiswa/delete/" + uuid,
                        type: 'POST',
                        data: {
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('guru_akademik-tugassiswa_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($dataTugasSiswa as $item)
                                    <tr>
                                        ...
                                        <td style="width: 150px">
                                            ...
                                            <a class="btn btn-outline-info btn-sm edit" title="Edit" href=" {{ route('guru_akademik-tugassiswa_edit', ['uuid' => $item->uuid]) }} ">
