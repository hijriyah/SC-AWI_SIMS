...
$(document).ready(function () {
    ...
    FilePond.setOptions({
        server: {
            process: {
                url: "{{ route('guru_akademik-materi_store') }}",
                method: 'POST',
                headers: {
    ...
    $('#tugasForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('guru_akademik-materi_page') }}"; 
                }, 2000);
            },
               ...
               <form id="tugasForm" enctype="multipart/form-data">
                 ...
                 <div class="row mb-4">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('guru_akademik-materi_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
