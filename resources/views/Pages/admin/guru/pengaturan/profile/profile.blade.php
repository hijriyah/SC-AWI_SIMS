                    ...
                    <div class="d-flex-justify content-start" style="line-height: 0.6;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p>Tanggal Bergabung: {{ $dataInfo->tanggal_bengabung }}</p>
                                ...
                                @if($dataInfo->aktif == "ya")
                                    <p>Aktif: <span class="badge badge-soft-success">{{ $dataInfo->aktif }}</span></p>
                                @else
                                    <p>Aktif: <span class="badge badge-soft-danger">{{ $dataInfo->aktif }}</span></p>
                                @endif
                            </div>
                        </div>  
                    </div>
