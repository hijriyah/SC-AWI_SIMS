    ...
    <script>
        ...
        function AddParent() {
            $('.modalContent').append(
                ...
                <form action="{{ route('guru_bukumedia_mediaparent_store') }} " method="POST">
                    @csrf
        ...
        function EditParent(uuid) {
            $.ajax({
                url: '/guru/dashboard/bukumedia/mediaparent/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/guru/dashboard/bukumedia/mediaparent/update/' + uuid;
        ...
        function DestroyParent(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/dashboard/bukumedia/mediaparent/delete/" + uuid,
                        type: 'POST',
                        data: {
        ...
        {
            let Url = '/guru/dashboard/bukumedia/mediasubf1/store/' + id_mediaParent;
            $('.modalContent').append(
        ...
        {
            $.ajax({
                url: '/guru/dashboard/bukumedia/mediasubf1/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/guru/dashboard/bukumedia/mediasubf1/update/' + uuid + '/' + id_mediaParent;
        ...
        function DestroyMediaSubF1(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/dashboard/bukumedia/mediasubf1/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        {
            let Url = '/guru/dashboard/bukumedia/mediasubf2/store/' + id_mediaSubF1;
            $('.modalContent').append(
        ...
        {
            $.ajax({
                url: '/guru/dashboard/bukumedia/mediasubf2/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/guru/dashboard/bukumedia/mediasubf2/update/' + uuid + '/' + id_mediaSubF1;
        ...
        function DestroyMediaSubF2(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/dashboard/bukumedia/mediasubf2/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        function AddMediaFile(id_mediaSubF2)
        {
            ...
            FilePond.setOptions({
                server: {
                    process: {
                        url: '/guru/dashboard/bukumedia/mediafile/store/' + id_mediaSubF2,
                        method: 'POST',
                        headers: {
            ...
            let Url = '/guru/dashboard/bukumedia/mediafile/store/' + id_mediaSubF2;
            $('#AddMediaFileForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{ route('guru_bukumedia_mediaparent_page') }}"; 
                        }, 2000);
                    },
        ...
        {
            $.ajax({
                url: '/guru/dashboard/bukumedia/mediafile/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                ...
                `
                    ...
                    FilePond.setOptions({
                        server: {
                            process: {
                                url: '/guru/dashboard/bukumedia/mediafile/update/' + uuid + '/' + id_mediaSubF2,
                                method: "POST",
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                                },
                    ...
                    let Url= '/guru/dashboard/bukumedia/mediafile/update/' + uuid + '/' + id_mediaSubF2;
                    let fileData = null;
        ...
        function DestroyMediaFile(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/dashboard/bukumedia/mediafile/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
                        ...
                        <div class="display-position" style="margin-bottom: 20px;">
                            <div class="d-flex justify-content-between mb-2">
                                <div style="margin-top: 10px;">
                                    <h4 class="card-title" style="width: 200px;"><b>Daftar Media Pembelajaran</b></h4>
                                </div>
                            </div>
