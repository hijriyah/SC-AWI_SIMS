           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Catatan WaliKelas</b></h4>
                        <div></div>
               ...
               <form action="{{ route('guru_raport-catatanwalikelas_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <label class="form-label">Catatan</label>
                                <input class="form-control" type="textarea" name="catatan" />
                                <!-- input-group -->
                        </div>
                      </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('guru_raport-catatanwalikelas_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
