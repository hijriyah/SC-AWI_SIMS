...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('guru_ujian-mulaiujian_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/guru/dashboard/ujian/mulaiujian/delete/" + uuid,
                        type: 'POST',
                        data: {
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 200px;"><b>Daftar Mulai Ujian</b></h4>
                            </div>
                            ...
                            <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('guru_ujian-mulaiujian_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($dataMulaiUjian as $item)
                                    <tr>
                                        ...
                                        <td style="width: 150px">
                                            ...
                                            <a class="btn btn-outline-info btn-sm edit" title="Edit" href=" {{ route('guru_ujian-mulaiujian_edit', ['uuid' => $item->uuid]) }} ">
