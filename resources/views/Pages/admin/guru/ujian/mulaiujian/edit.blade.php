...
$(document).ready(function () {
    ...
    FilePond.setOptions({
        server: {
            process: {
                url: "{{ route('guru_ujian-mulaiujian_update', ['uuid' => $dataEdit->uuid]) }}",
                method: 'POST',
                headers: {
    ...
    $('#mulaiUjianForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('guru_ujian-mulaiujian_page') }}"; 
                }, 2000);
            },
           ...
           <div class="card-body">
               ...
               <form id="mulaiUjianForm" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('guru_ujian-mulaiujian_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
