   ...
   <div class="col-lg-12">
       <div class="card">
           <div class="card-body">
               ...
               <form action="{{ route('guru_ujian-jadwalujian_update', ['uuid' => $dataEdit->uuid]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-4 mt-lg-0 mb-3">
                                ...
                                <select class="form-select" placeholder="Pilih" name="id_rencana_ujian">
                                    ...
                                    @foreach($dataRencanaUjian as $rencanaujian)
                                        <option value="{{ $rencanaujian->id }}" {{ old('id_rencana_ujian', $rencanaujian->id) == $dataEdit->id_rencana_ujian ? 'selected' : '' }}>{{ $rencanaujian->rencana_ujian }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mt-4 mt-lg-0 mb-3">
                                ...
                                <select class="form-select" placeholder="Pilih" name="id_kelas">
                                    ...
                                    @foreach($dataKelas as $kelas)
                                        <option value="{{ $kelas->id }}" {{ old('id_kelas', $kelas->id) == $dataEdit->id_kelas ? 'selected' : '' }}>{{ $kelas->nama }}</option>
                                    @endforeach
                                </select>
                                @error('id_kelas')
                                    <span class="text-sm text-danger">{{ $message }}</span>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group" id="datepicker3">
                                    ...
                                    <input type="date" class="form-control" placeholder="yyyy-mm-dd" name="tanggal_ujian" value="{{ $dataEdit->tanggal_ujian }}" />
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control" name="ujian_dari" value="{{ $dataEdit->ujian_dari }}" />
                            @error('ujian_dari')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control" name="ujian_untuk" value="{{ $dataEdit->ujian_untuk }}" />
                            @error('ujian_untuk')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="ruangan" value="{{ $dataEdit->ruangan }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('guru_ujian-jadwalujian_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
