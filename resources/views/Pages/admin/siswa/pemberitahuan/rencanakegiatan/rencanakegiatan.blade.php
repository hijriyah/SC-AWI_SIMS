        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/rencanakegiatan/delete/" + uuid,
                        type: 'POST',
                        data: {
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 150px; margin-top: 10px;"><b>Daftar Rencana Kegiatan</b></h4>
                            </div>
                            <div class="div"></div>
                            ...
                            {{-- <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('pemberitahuan_rencanakegiatan_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div> --}}
                        </div>
                    </div>
