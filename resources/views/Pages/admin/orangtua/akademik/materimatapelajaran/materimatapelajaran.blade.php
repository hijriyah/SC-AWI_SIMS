...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('orangtua_akademik-materimatapelajaran_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/akademik/materimatapelajaran/delete/" + uuid,
                        type: 'POST',
                        data: {
                ...
                <div class="card-body">
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 250px;"><b>Daftar Materi Mata Pelajaran</b></h4>
                            </div>
                            <div class="div"></div>
                            ...
                            {{-- <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('akademik_materimatapelajaran_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div> --}}
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-editable table-nowrap align-middle table-edits">
                            ...
                            <tbody id="table-body">
                                @foreach ($dataMateriMataPelajaran as $item)
                                    <tr>
                                        ...
                                        <td style="width: 150px">
                                            ...
                                            <a class="btn btn-outline-info btn-sm edit" title="Edit" href=" {{ route('akademik_materimatapelajaran_edit', ['uuid' => $item->uuid]) }} ">
