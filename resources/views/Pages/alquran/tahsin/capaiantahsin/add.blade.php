           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Capaian Tahsin</b></h4>
                        <div></div>
               ...
               <form action="{{ route('alquran_tahsin_capaiantahsin_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <select class="form-select" placeholder="Pilih" name="id_pemetaan_tahsin">
                                  <option selected disabled>Pilih</option>
                                  @foreach($dataPemetaanTahsin as $pemetaantahsin)
                                     <option value="{{ $pemetaantahsin->id }}">{{ $pemetaantahsin->semester }}</option>
                                  @endforeach
                              </select>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="textarea" name="semester" />
                                <!-- input-group -->
                            </div>
                        </div>
                    </div>
