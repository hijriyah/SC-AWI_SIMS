           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Edit Tata Tertib</b></h4>
                        <div></div>
               ...
               <form action="{{ route('kesiswaan_tatatertib_update', ['uuid' => $dataEdit->uuid]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <label class="form-label">Jenis Tata Tertib</label>
                                <input class="form-control" name="jenis_tata_tertib" value="{{ $dataEdit->jenis_tata_tertib }}" /><br>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('kesiswaan_tatatertib_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
