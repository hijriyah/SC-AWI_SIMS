           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Data Pelanggaran</b></h4>
                        <div></div>
               ...
               <form action="{{ route('kesiswaan_datapelanggaran_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                           ...
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <select class="form-select" placeholder="Pilih" name="id_pelanggaran">
                                  ...
                                  @foreach($dataPelanggaran as $pelanggaran)
                                     <option value="{{ $guru->id }}">{{ $pelanggaran->jenis_pelanggaran }}</option>
                                  @endforeach
                              </select>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" name="subtotal_poin" />
                                <!-- input-group -->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" name="total_poin" />
                                <!-- input-group -->
                            </div>
                        </div>
                           ...
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <select class="form-select" placeholder="Pilih" name="id_sanksi_pelanggaran">
                                  ...
                                  @foreach($dataSanksiPelanggaran as $sanksipelanggaran)
                                     <option value="{{ $sanksipelanggaran->id }}">{{ $sanksipelanggaran->bentuk_sanksi }}</option>
                                  @endforeach
                              </select>
                        </div>
                      </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('kesiswaan_datapelanggaran_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
               </form>
           </div>
       </div>
