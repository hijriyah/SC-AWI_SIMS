    ...
    <script>
        ...
        function AddParent() {
            $('.modalContent').append(
                ...
                <form action="{{ route('pemberitahuan_kegiatan_gkmediaparent_store') }} " method="POST">
                    @csrf
        ...
        function EditParent(uuid) {
            $.ajax({
                url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediaparent/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediaparent/update/' + uuid;
        ...
        function DestroyParent(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/kegiatan/gkmediaparent/delete/" + uuid,
                        type: 'POST',
                        data: {
        ...
        {
            let Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf1/store/' + id_gkmediaparent;
            $('.modalContent').append(
        ...
        {
            $.ajax({
                url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf1/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf1/update/' + uuid + '/' + id_gkmediaparent;
        ...
        function DestroyMediaSubF1(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf1/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        {
            let Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf2/store/' + id_gkmediasubf1;
            $('.modalContent').append(
        ...
        {
            $.ajax({
                url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf2/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf2/update/' + uuid + '/' + id_mediaSubF1;
        ...
        function DestroyMediaSubF2(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/kegiatan/gkmediasubf2/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        function AddMediaFile(id_gkmediasubf2)
        {
            ...
            FilePond.setOptions({
                server: {
                    process: {
                        url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/store/' + id_gkmediasubf2,
                        method: 'POST',
                        headers: {
            ...
            let Url = '/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/store/' + id_mediaSubF2;
            $('#AddMediaFileForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{ route('pemberitahuan_kegiatan_gkmediaparent_page') }}"; 
                        }, 2000);
                    },
        ...
        {
            $.ajax({
                url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                ...
                `
                    ...
                    FilePond.setOptions({
                        server: {
                            process: {
                                url: '/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/update/' + uuid + '/' + id_mediaSubF2,
                                method: "POST",
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                                },
                    ...
                    let Url= '/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/update/' + uuid + '/' + id_mediaSubF2;
                    let fileData = null;
        ...
        function DestroyMediaFile(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/kegiatan/gkmediafile/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
