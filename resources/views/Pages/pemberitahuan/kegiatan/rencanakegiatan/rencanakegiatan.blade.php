...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('pemberitahuan_kegiatan_rencanakegiatan_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/pemberitahuan/kegiatan/rencanakegiatan/delete/" + uuid,
                        type: 'POST',
                        data: {
                    ...
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 200px; margin-top: 10px;"><b>Daftar Rencana Kegiatan</b></h4>
                            </div>
                            ...
                            <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('pemberitahuan_kegiatan_rencanakegiatan_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($dataRencanaKegiatan as $item)
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            <a class="btn btn-outline-info btn-sm edit" title="Edit" href=" {{ route('pemberitahuan_kegiatan_rencanakegiatan_edit', ['uuid' => $item->uuid]) }} ">
