           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Rekap Kelengkapan Arsip</b></h4>
                        <div></div>
               ...
               <form action="{{ route('arsipguru_rekapkelengkapanarsip_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <select class="form-select" placeholder="Pilih" name="id_upload_arsi">
                                  <option selected disabled>Pilih</option>
                                  @foreach($dataUploadArsip as $uploadarsip)
                                     <option value="{{ $uploadarsip->id }}">{{ $uploadarsip->judul }}</option>
                                  @endforeach
                              </select><br>

                              <label class="form-label">Status Kelengkapan</label>
                                <select class="form-select" placeholder="Pilih" name="status_kelengkapan">
                                    <option selected disabled>Pilih</option>
