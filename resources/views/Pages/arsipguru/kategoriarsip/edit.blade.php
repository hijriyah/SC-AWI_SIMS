           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Edit Kategori Arsip</b></h4>
                        <div></div>
               ...
               <form action="{{ route('arsipguru_kategoriarsip_update', ['uuid' => $dataEdit->uuid]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="kategori_arsip" value="{{ $dataEdit->kategori_arsip }}" /><br>
                                <!-- input-group -->
