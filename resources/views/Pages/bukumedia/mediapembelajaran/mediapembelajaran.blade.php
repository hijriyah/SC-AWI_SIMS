    ...
    <script>
        ...
        function AddParent() {
            $('.modalContent').append(
                ...
                <form action="{{ route('bukumedia_mediaparent_store') }} " method="POST">
                    @csrf
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="AddParent">Tambah Media Pembelajaran</h1>
        ...
        function EditParent(uuid) {
            $.ajax({
                url: '/administrator/dashboard/bukumedia/mediaparent/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/bukumedia/mediaparent/update/' + uuid;
        ...
        function DestroyParent(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/bukumedia/mediaparent/delete/" + uuid,
                        type: 'POST',
                        data: {
        ...
        function AddMediaSub1(id_mediaParent)
        {
            let Url = '/administrator/dashboard/bukumedia/mediasubf1/store/' + id_mediaParent;
            $('.modalContent').append(
        ...
        function EditMediaSubF1(uuid, id_mediaParent)
        {
            $.ajax({
                url: '/administrator/dashboard/bukumedia/mediasubf1/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/bukumedia/mediasubf1/update/' + uuid + '/' + id_mediaParent;
        ...
        function DestroyMediaSubF1(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/bukumedia/mediasubf1/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        function AddMediaSub2(id_mediaSubF1)
        {
            let Url = '/administrator/dashboard/bukumedia/mediasubf2/store/' + id_mediaSubF1;
            $('.modalContent').append(
        ...
        function EditMediaSubF2(uuid, id_mediaSubF1)
        {
            $.ajax({
                url: '/administrator/dashboard/bukumedia/mediasubf2/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                    const Url = '/administrator/dashboard/bukumedia/mediasubf2/update/' + uuid + '/' + id_mediaSubF1;
        ...
        function DestroyMediaSubF2(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/bukumedia/mediasubf2/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
        ...
        function AddMediaFile(id_mediaSubF2)
        {
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="link" placehoolder="Link" />
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12">
            ...
            FilePond.setOptions({
                server: {
                    process: {
                        url: '/administrator/dashboard/bukumedia/mediafile/store/' + id_mediaSubF2,
                        method: 'POST',
                        headers: {
            ...
            let Url = '/administrator/dashboard/bukumedia/mediafile/store/' + id_mediaSubF2;
            $('#AddMediaFileForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{ route('bukumedia_mediaparent_page') }}"; 
                        }, 2000);
                    },
        ...
        function EditMediaFile(uuid, id_mediaSubF2)
        {
            $.ajax({
                url: '/administrator/dashboard/bukumedia/mediafile/edit/' + uuid,
                type: 'GET',
                success: (response) => {
                    $('.modal').remove();
                        ...
                        <form id="EditMediaFileForm" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <label class="form-label">Link</label>
                                        <input type="text" class="form-control" name="link" placehoolder="Link" value="${response.data.link}" />
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12">
                ...
                `
                    ...
                    FilePond.setOptions({
                        server: {
                            process: {
                                url: '/administrator/dashboard/bukumedia/mediafile/update/' + uuid + '/' + id_mediaSubF2,
                                method: "POST",
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                                },
                    ...
                    let Url= '/administrator/dashboard/bukumedia/mediafile/update/' + uuid + '/' + id_mediaSubF2;
                    let fileData = null;
        ...
        function DestroyMediaFile(uuid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/bukumedia/mediafile/delete/" + uuid,
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            _method: 'DELETE'
