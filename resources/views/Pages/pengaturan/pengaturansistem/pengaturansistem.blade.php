        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('pengaturan_pengaturansistem_modify') }}" method="POST">
                        @csrf
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <label class="form-label" for="username">Username</label>
                                <input type="text" name="username" class="form-control" id="username" value="{{ $getUserProfile->username }}" placeholder="Username" />
                                @error('username')
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-sm btn-success"><i class="mdi mdi-telegram"></i> Kirim</button>
                        </div>
                    </form>
                </div>
            </div>
