   ...
   <div class="col-lg-12">
       <div class="card">
           <div class="card-body">
               ...
               <form action="{{ route('pengaturan_role_update', ['id' =>  $dataEdit->id]) }}" method="POST">
                  @method('PUT')
                    @csrf
                    <div class="row mb-4 mt-3">
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="name" placeholder="Nama" value="{{ $dataEdit->name }}" />
                        </div>
                    </div>
                    @foreach($dataPermission as $permission)
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" 
                                 ...
                                 name="permission[]"
                                 {{ in_array($permission->id, $dataRolesHas) ? 'checked' : '' }}>
