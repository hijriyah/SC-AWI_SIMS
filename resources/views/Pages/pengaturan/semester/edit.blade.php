           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Edit Semester</b></h4>
                        <div></div>
               ...
               <form action="{{ route('pengaturan_semester_update', ['uuid' => $dataEdit->uuid]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="semester" value="{{ $dataEdit->semester }}" /><br>
                                <!-- input-group -->

                                <label class="form-label">Semester Huruf</label>
                                <input class="form-control" name="semester_huruf" value="{{ $dataEdit->semester }}" /><br>
