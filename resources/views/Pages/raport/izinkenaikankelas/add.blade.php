           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Perizinan Kenaikan kelas</b></h4>
                        <div></div>
               ...
               <form action="{{ route('raport_izinkenaikankelas_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
