           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Edit Nilai Ekstrakurikuler</b></h4>
                        <div></div>
               ...
               <form action="{{ route('raport_nilaiekstrakurikuler_update', ['uuid' => $dataEdit->uuid]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                              ...
                              <select class="form-select" placeholder="Pilih" name="id_ekstrakurikuler">
                                  <option selected disabled>Pilih</option>
                                  @foreach($dataEkstrakurikuler as $ekstrakurikuler)
                                  <option value="{{ $ekstrakurikuler->id }}" {{ old('id_ekstrakurikuler', $ekstrakurikuler->id ) == $dataEdit->id_ekstrakurikuler ? 'selected' : ''}}>{{ $ekstrakurikuler->ekstrakurikuler }}</option>
                                  @endforeach
                              </select>
                         </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" name="nilai" value="{{ $dataEdit->nilai }}" />
                      </div>
                      <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('raport_nilaiekstrakurikuler_page') }}" class="btn btn-sm btn-danger" style="height: 29px;"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
                    </div>
