           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Nilai Ekstrakurikuler</b></h4>
                        <div></div>
               ...
               <form action="{{ route('raport_nilaiekstrakurikuler_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="textarea" name="keterangan" />
                                <!-- input-group -->
                            </div>
                        </div>
                    </div>
