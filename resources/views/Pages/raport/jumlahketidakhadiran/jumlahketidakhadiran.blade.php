...
<script>
    ...
    function SearchData()
    {
        ...
        $.ajax({
            url: "{{ route('raport_jumlahketidakhadiran_page') }}",
            type: "GET",
            data: { search: search},
        ...
        $('.delete-button').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/administrator/dashboard/raport/juaraumum/delete/" + uuid,
                        type: 'POST',
                        data: {
                ...
                <div class="card-body">
                    <div class="display-position" style="margin-bottom: 20px;">
                        <div class="d-flex justify-content-between">
                            <div style="margin-top: 0px;">
                                <h4 class="card-title" style="width: 250px;"><b>Jumlah Ketidakhadiran Siswa</b></h4>
                            </div>
                            ...
                            <div style="margin-top: 0px; width: 100px;">
                                <a class="btn btn-sm btn-success" href="{{ route('raport_jumlahketidakhadiran_add') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-editable table-nowrap align-middle table-edits">
                            ...
                            <tbody id="table-body">
                                @foreach ($dataJumlahKetidakhadiran as $item)
                                    <tr>
                                       ...
                                       <td>{{ $item->tipe_juara}} </td>
                                        ...
                                        <td style="width: 100px">
                                            <a class="btn btn-outline-info btn-sm edit" title="Edit" href=" {{ route('raport_jumlahketidakhadiran_edit', ['uuid' => $item->uuid]) }} ">
                    ...
                    <div class="d-flex justify-content-start">
                        {{ $dataJumlahKetidakhadiran->links() }}
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
