           ...
           <div class="card-body">
                <div class="position-custom">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3"><b>Tambah Juara Umum</b></h4>
                        <div></div>
               ...
               <form action="{{ route('raport_juaraumum_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                           <div class="mt-4 mt-lg-0 mb-3">
                                ...
                                <select class="form-select" placeholder="Pilih" name="tipe_juara">
                                    <option selected disabled>Pilih</option>
                                    <option value="semua">Semua</option>
                                    <option value="perjenjang">Perjenjang</option>
                                </select>
                           </div>
                       </div>
                    </div>
