@foreach ($dataJadwalPelajaran as $item)
    <tr>
        ...
        <td><span style="background-color: {{ $item->warna }}; padding: 5px; color: black;">{{ $item->guru->nama_lengkap }}</span> </td>
        ...
        <td style="width: 150px">
            <a class="btn btn-outline-info btn-sm edit" title="Edit"
                href=" {{ route('penjadwalan_jadwalpelajaran_edit', ['uuid' => $item->uuid]) }} ">
